...
2. **リアルタイムスペクトログラム ＆ 周波数解析ビジュアライザー (New)**
...
3. **ドラッグ＆ドロップ一括バッチ音声変換 (Batch Audio Processor) (New)**
...
4. **ノイズキャンセリング・音声フィルター ＆ 3バンドEQ (Audio Filter Chain) (New)**
...
5. **グローバル英語・ビジネス動画向け プリセット音声 (完全無料・商用フリー全25種類 ＋ ローカルモデル)**
...
6. **改行ごと分割WAV出力 ＆ カスタムファイル名命名規則 (ZIPエクスポート)**
...
7. **音声精度 ＆ 原稿一致照合診断 (Speech Alignment & Verification Engine)**
...
8. **Q3-TTS コントロール仕様 ＆ ドラッグ＆ドロップ原稿読み込み**
...
9. **Step Audio EditX 音声編集・修復エンジン**
